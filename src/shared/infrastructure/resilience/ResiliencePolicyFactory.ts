...
// aws-xray-sdk-core es CJS puro; bajo tsx, getSegment no se detecta como named
// export y queda undefined. Fallback a .default necesario para que el seed y
// `pnpm dev` no rompan (esbuild/Lambda ya lo resuelve bien).
