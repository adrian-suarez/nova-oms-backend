...
export class UserSeeder {
  ...
  async seed(): Promise<void> {
    ...
    for (const user of UserCatalog) {
      ...
      // El seed corre en cada push, no solo una vez. El upsert de Postgres es idempotente pero
      // Cognito no — falla si el usuario ya existe. Se chequea antes para crear solo los nuevos.
